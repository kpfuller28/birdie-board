# Generated by Django 4.2.23 on 2025-06-12 18:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='round',
            constraint=models.UniqueConstraint(fields=('user', 'id'), name='unique_round_per_user'),
        ),
        migrations.AddConstraint(
            model_name='hole',
            constraint=models.UniqueConstraint(fields=('round', 'hole'), name='unique_hole_per_round'),
        ),
    ]
